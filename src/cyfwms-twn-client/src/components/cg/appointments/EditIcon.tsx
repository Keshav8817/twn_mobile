...
import { deleteCgAppointment } from "../../../pages/cg/appointments/service";
const style = {
...
const EditIcon: FC<any> = ({ setDisabled, setAddNew, icappointmentId }) => {
  ...
  const handleDelete = () => {
    deleteCgAppointment(icappointmentId).then(() => {
      navigate(`../appointments/${id}`);
    });
  };
