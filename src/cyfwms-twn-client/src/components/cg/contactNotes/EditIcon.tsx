...
import { deleteCgContactNotes } from "../../../pages/cg/ContactNotes/ContactNotesService";
const style = {
...
const EditIcon: FC<any> = ({ setDisabled, setAddNew, contactId }) => {
  ...
  const handleDelete = () => {
    deleteCgContactNotes(contactId).then(() => {
      navigate(`../contact_notes/${id}`);
    });
  };
