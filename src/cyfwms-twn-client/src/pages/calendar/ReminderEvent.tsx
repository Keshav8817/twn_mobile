...
const ReminderEvent: any = (props: any) => {
  ...
  const iMatch = useMediaQuery(theme.breakpoints.down("sm"));
  ...
  useEffect(() => {
    if (props.date) {
      getAllReminderByDate(props.date).then((response) => {
              ...
              {data.map((val: any, key: any) => (
                ...
                >
                  ...
                  >
                    ...
                    {val.fileDetailsId && (
                      <Link
                        to={`/ic/reminder/${val.fileDetailsId}`}
                        onClick={() => {
                          popupDispatchContext({
                            type: "open",
                            open: true,
                    ...
                    {val.cgProviderId && (
                      <Link
                        to={`/cg/reminders/${val.cgProviderId}`}
                        onClick={() => {
                          popupDispatchContext({
                            type: "open",
                            open: true,
