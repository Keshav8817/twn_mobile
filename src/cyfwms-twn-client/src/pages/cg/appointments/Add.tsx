...
import { postCgAppointment, getCgAppointment } from "./service";
...
const Add: FC<any> = ({ setDisabled, disabled, targetValue }) => {
  ...
  useEffect(() => {
    ...
    getCgAppointment(Number(id)).then(({ data }) => {
  ...
  const submitHandler = (e: FormEvent) => {
    ...
    if (!click) {
      ...
      const formData: Data = {
        cgappointmentId: state.cgappointmentId,
        id: Number(id),
...
export { Add as CgAppointmentAdd };
